<header class="bg-white shadow-sm">
    <div class="container mx-auto max-w-7xl px-4 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-6">
            <!-- Search -->
            <form action="{{ route('home.search') }}" method="GET" class="relative  lg:block m-0">
                <input
                    type="text"
                    name="q"
                    ...
                    <div x-show="open"
                        ...
                        <div class="max-h-96 overflow-y-auto">
                            ...
                            <a href="{{ $notification['link'] }}"
                                class="block px-4 py-3 hover:bg-gray-50 transition {{ $notification['read'] ? '' : 'bg-blue-50' }}">
                            ...
                            @endforeach
                            @else
                            <p class="px-4 py-3 text-gray-500">Chưa có thông báo nào</p>
                            @endif
                        </div>
                    </div>
