        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div class="space-y-4">
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="https://youtube.com" target="_blank" class="text-gray-400 hover:text-white transition-colors">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                        </svg>
                    </a>
                    <a href="https://tiktok.com" target="_blank" class="text-gray-400 hover:text-white transition-colors">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-sm hover:text-white transition-colors">Trang Chủ</a></li>
                    <li><a href="#" class="text-sm hover:text-white transition-colors">Dịch Vụ</a></li>
                    <li><a href="#" class="text-sm hover:text-white transition-colors">Sản Phẩm</a></li>
            ...
            <!-- Contact Info -->
            <div class="space-y-4">
                <h3 class="text-white text-lg font-semibold">Liên Hệ</h3>
                <ul class="space-y-2">
                    ...
                    <li class="flex items-center space-x-2">
                        ...
                        <span class="text-sm">(028) 1234 5678</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="border-t border-gray-800 mt-12 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6 mt-4 md:mt-0">
                    <a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">Chính sách bảo mật</a>
                    <a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">Điều khoản dịch vụ</a>
                    <a href="#" class="text-sm text-gray-400 hover:text-white transition-colors">Chính sách cookie</a>
                </div>
            </div>
        </div>
    </div>
