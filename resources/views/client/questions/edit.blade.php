...
<body>
    ...
    <div class="container mx-auto max-w-7xl px-4 py-8">
        <h2 class="text-2xl font-bold mb-6">Chỉnh sửa câu hỏi</h2>
        ...
        <form action="{{ route('questions.update', $question->slug) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" required value="{{ $question->title }}" placeholder="Nhập tiêu đề câu hỏi của bạn">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="edit" name="content" required>{{ $question->content }}</textarea>
            </div>
