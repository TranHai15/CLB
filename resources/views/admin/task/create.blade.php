...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
            <a href="{{ isset($plan) ? route('admin.plans.show', $plan) : route('admin.plans.index') }}" class="btn border-gray-200 hover:border-gray-300 text-gray-600">
            ...
            <form action="{{ route('admin.tasks.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">Tạo nhiệm vụ</button>
                    </div>
                </div>
            </form>
    </div>
