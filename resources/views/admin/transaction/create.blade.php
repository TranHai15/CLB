            ...
            <div class="space-y-6">
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="description" id="description" value="{{ old('description') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                        @error('description')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <input type="number" name="amount" id="amount" value="{{ old('amount') }}" min="0" step="1000" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="mt-2 space-y-2">
                            <div class="flex items-center">
                                <input id="income" name="type" type="radio" value="income" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300" {{ old('type') == 'income' ? 'checked' : '' }} required>
                            ...
                            <div class="flex items-center">
                                <input id="expense" name="type" type="radio" value="expense" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300" {{ old('type') == 'expense' ? 'checked' : '' }}>
                ...
                <div class="flex justify-end">
                    <button type="submit" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">Tạo giao dịch</button>
                </div>
            </div>
        </form>
    </div>
