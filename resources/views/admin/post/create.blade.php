            ...
            <div class="space-y-6">
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="content" id="edit" rows="10" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('content') }}</textarea>
                        @error('content')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex justify-end">
                    <button type="submit" class=" flex items-center btn bg-indigo-500 hover:bg-indigo-600 text-white">Tạo bài đăng</button>
                </div>
            </div>
        </form>
